{
	...
	"lastUpdated": "2012-07-24 07:05:00"
}
...
FW.Scraper({ itemType         : 'magazineArticle',
			 detect           : FW.Xpath('//div[@class="issue"]/a[contains(text(),"Журнал")]|//div[@class="issue"]/a[contains(text(),"Еженедельник")]'),
			 ...
			 publicationTitle : FW.Xpath('//div[@class="issue"]/a').text().match(/^\s*(Журнал|Еженедельник)\s+"([^"]+)"/,2)
});
...
FW.MultiScraper({ itemType  : "multiple",
				  ...
				  choices : {
					titles    : FW.Xpath('//table[contains(@class,"searchresults")]//a[@class="f-z"]').text(),
				  	urls      : FW.Xpath('//table[contains(@class,"searchresults")]//a[@class="f-z"]').key('href').text()         
				  }
});
